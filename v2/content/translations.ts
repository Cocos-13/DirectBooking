...
export const translations: Record<Lang, Dictionary> = {
  el: {
    ...
    form: {
      ...
      errorMinStay: "Η ελάχιστη διαμονή είναι 2 διανυκτερεύσεις. Παρακαλούμε επιλέξτε μία ακόμη ημέρα.",
  ...
  en: {
    ...
    form: {
      ...
      errorMinStay: "Minimum stay is 2 nights. Please pick one more day.",
