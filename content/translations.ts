...
export const translations: Record<Lang, Dictionary> = {
  el: {
    ...
    description: {
      ...
      paragraphs: [
        "TODO: Προσθέστε εδώ την περιγραφή του διαμερίσματος στα ελληνικά — μέγεθος, διαρρύθμιση, ατμόσφαιρα, τι το κάνει ξεχωριστό.",
    ...
    amenities: {
      ...
      items: [
        "TODO: Wi-Fi",
        "TODO: Πλήρως εξοπλισμένη κουζίνα",
        "TODO: Κλιματισμός",
        "TODO: Πλυντήριο ρούχων",
        "TODO: Smart TV",
        "TODO: Ασανσέρ",
      ],
    },
