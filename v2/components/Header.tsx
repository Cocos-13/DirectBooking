...
export function Header() {
  return (
    <header className="sticky top-0 z-50 h-16">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-44 bg-sand-50/70 backdrop-blur-xl [mask-image:linear-gradient(to_bottom,black_0%,black_40%,rgba(0,0,0,0.55)_58%,rgba(0,0,0,0.22)_78%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_bottom,black_0%,black_40%,rgba(0,0,0,0.55)_58%,rgba(0,0,0,0.22)_78%,transparent_100%)] dark:bg-ink-bg/70"
      />
